...
import org.cloudbus.cloudsim.sdn.policies.OverbookingNetworkOperatingSystem;
import org.cloudbus.cloudsim.sdn.policies.OverbookingNetworkOperatingSystemGroup;
...
import org.cloudbus.cloudsim.sdn.vmallocation.overbooking.HostSelectionPolicy;
import org.cloudbus.cloudsim.sdn.vmallocation.overbooking.HostSelectionPolicyMostFull;
...
import org.cloudbus.cloudsim.sdn.vmallocation.overbooking.OverbookingVmAllocationPolicyConsolidateCorrelated;
import org.cloudbus.cloudsim.sdn.vmallocation.overbooking.OverBookingVmAllocationPolicyDistributeCorrelated;
...
import org.cloudbus.cloudsim.sdn.vmallocation.overbooking.VmMigrationPolicy;
			...
			case Consolidate:
				...
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> list,
						...
						return new OverbookingVmAllocationPolicyConsolidateCorrelated(list, hostSelectionPolicy, vmMigrationPolicy); 
					}
				};
				snos = new OverbookingNetworkOperatingSystemGroup(physicalTopologyFile);
				hostSelectionPolicy = new HostSelectionPolicyMostFull();
				vmMigrationPolicy = null;
				break;
			case Separate:
				...
				vmAllocationFac = new VmAllocationPolicyFactory() {
					public VmAllocationPolicy create(List<? extends Host> list,
						...
						return new OverBookingVmAllocationPolicyDistributeCorrelated(list, hostSelectionPolicy, vmMigrationPolicy); 
					}
				};
				snos = new OverbookingNetworkOperatingSystemGroup(physicalTopologyFile);
				hostSelectionPolicy = new HostSelectionPolicyMostFull();
